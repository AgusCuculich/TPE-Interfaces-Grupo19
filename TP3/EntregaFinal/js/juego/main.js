...
//
//
// let renderQueue = [];   //Lista de todas las figuras dibujadas
...
//
//
//     let circle = new Chip(posX,posY, radius, color, ctx, true);
...
//     clearCanvas();
//     for (let i = 0; i < renderQueue.length; i++){
//         renderQueue[i].draw();  //Aprovecha binding dinamico para dibujar cualquier figura
//     }
// }
//
//
...
//     }
//     newFrame(); //Refresca la pantalla, creando un nuevo frame
//
//
//
// }
...
//
//
//        let circle = new Chip(posX,posY, radius, color, ctx);
//        figures.push(circle);
//        drawFigure();
//    }
// }
